...
Linux, Windows
🚀 Projects
[Self-Healing Infrastructure with Prometheus, Alertmanager & Ansible](https://github.com/ZainabKousar/Self-Heal-Project.git)
Automated monitoring and incident recovery system using Prometheus and Ansible to ensure uptime and resilience.

[Scalable Static Website with S3, Cloudflare & GitHub Actions](https://github.com/ZainabKousar/s3-cloudflare-actions-site.git)
...
🔗 [Zainab Kousar](https://github.com/ZainabKousar) – GitHub
